...
import facedemo.opencv.zhongke.facedemo.R;
	...
	public Object onPreview(byte[] data, int width, int height, int format, long timestamp) {
		...
		for (AFT_FSDKFace face : result) {
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					String  vd="NULL";
					if (genders.get(0).getGender()==0){
						  vd="Face:"  + ",age:" + ages.get(0).getAge() + ",gender:" + "男";
					}else if (genders.get(0).getGender()==1){
						vd="Face:"  + ",age:" + ages.get(0).getAge() + ",gender:" + "女";
					}else {
						vd="Face:"  + ",age:" + ages.get(0).getAge() + ",gender:" + "未知";
					}
